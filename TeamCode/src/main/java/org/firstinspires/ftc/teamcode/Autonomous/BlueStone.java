...
@Autonomous (name = "Blue 1 Stone", group = "Autonomous")
public class BlueStone extends robot {
        ...
        if (opModeIsActive()) {
            ...
            switch (pos) {
                ...
                case LEFT: {
                    ...
                    //
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 2000) {
                    ...
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 3350) {
                        gyroDrive(270, 0.8, -0.8, -0.8, 0.8);
                    }
                    zero();
                    turnRight();
                    ...
                    sleep(100);
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 3600) {
                        gyroDrive(270, -0.8, 0.8, 0.8, -0.8);
                    }
                    zero();
                    grabber.BLOCKGRABBER.deactivate();
                    sleep(500);
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 800) {
                        gyroDrive(270, 0.8, -0.8, -0.8, 0.8);
                    }
                    zero();
                    break;
                ...
                case RIGHT: {
                    ...
                    turnLeft();
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 3300) {
                        gyroDrive(270, -0.8, 0.8, 0.8, -0.8);
                    }
                    zero();
                    grabber.BLOCKGRABBER.deactivate();
                ...
                case CENTER: {
                    ...
                    //
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 2700) {
                        gyroDrive(270, -0.8, 0.8, 0.8, -0.8);
                    }
                    zero();
                    grabber.BLOCKGRABBER.deactivate();
                    ...
                    arm.setPosition(GlobalPositions.ARM_DOWN);
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 4000) {
                        gyroDrive(270, 0.8, -0.8, -0.8, 0.8);
                    }
                    zero();
                    turnRight();
                    ...
                    sleep(500);
                    gyroDrive.reset();
                    while (gyroDrive.milliseconds() < 650) {
                        gyroDrive(270, 0.8, -0.8, -0.8, 0.8);
                    }
                    zero();
                    break;
